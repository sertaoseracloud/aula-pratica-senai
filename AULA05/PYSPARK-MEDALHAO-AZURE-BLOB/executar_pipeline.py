"""Roda os tres jobs da arquitetura medalhao (com Azure Blob) em sequencia.
...
O que muda aqui: a "camada anterior" que cada job le nao e mais so a pasta
local -- e o Blob. Rodar os tres em sequencia continua sendo suficiente,
porque cada job baixa o que precisa antes de comecar.
"""
...
def main() -> None:
    ...
    print("\nPipeline completo: Bronze -> Silver -> Gold, tudo no Blob.")
