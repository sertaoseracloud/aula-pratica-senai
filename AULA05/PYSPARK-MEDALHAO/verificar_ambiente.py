...
E o mesmo `verificar_ambiente.py` das outras aulas de PySpark -- Python,
Java, PySpark e (no Windows) o winutils. Este laboratorio nao depende de
Docker nem de nenhum SDK de nuvem: as tres camadas moram no seu disco.

Nao sobe sessao Spark: roda em ~1 s.
"""
