...
E o mesmo `verificar_ambiente.py` da AULA03, com duas checagens a mais no
fim: o SDK do Azure Blob Storage instalado, e o floci-az respondendo na
porta 4577. As quatro primeiras (Python, PySpark, Java, winutils) sao
identicas -- o Spark aqui continua rodando local[4] na sua maquina.
...
# 6. Emulador de Blob (floci-az) respondendo -----------------------------------
try:
